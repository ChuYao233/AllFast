...
func main() {
	...
	auth.Use(middleware.AuthRequired())
	{
		...
		auth.POST("/sites/:id/tracking/reset", handler.ResetTrackingID)
	...
	// 公开访问（无需登录，但走 /api 前缀以便前端代理）
	r.GET("/api/share/analytics/:token/stats", handler.GetPublicTrackingStats)
